...
public class InitData {
    ...
    public InitData(MemberService memberService, ActivityService activityService) {
    ...
    public void init(){
        ...
        activityService.createActivity(new ActivityRequest("테스트활동1","테스트활동내용1", "화이팅1", ActivityType.SESSION, 10, "도서관1", "주의하시오1", List.of( // recurringSchedules
        ...
        activityService.createActivity(new ActivityRequest("테스트활동2","테스트활동내용2", "화이팅2", ActivityType.GENERAL, 11, "도서관2", "주의하시오2", List.of( // recurringSchedules
        ...
        activityService.createActivity(new ActivityRequest("테스트활동1","테스트활동내용1", "화이팅1", ActivityType.PROJECT, 12, "도서관3", "주의하시오3", List.of( // recurringSchedules
