    ...
    public SecurityFilterChain filterChain(HttpSecurity http, RefreshRepository refreshRepository) throws Exception {
        ...
        http
                .authorizeHttpRequests((auth) -> auth
                        .requestMatchers("/login", "/", "/reissue", "/swagger-ui/**", "/v3/api-docs/**", "/api/member", "/api/activities", "/api/activities/**", "/api/**").permitAll()
        ...
        http
                .cors(cors -> cors.configurationSource(new CorsConfigurationSource() {
                    ...
                    public CorsConfiguration getCorsConfiguration(HttpServletRequest request) {
                        ...
                        configuration.setAllowedOrigins(List.of("http://175.123.55.182", "http://localhost:3000", "https://jbnucpu.co.kr", "http://jbnucpu.co.kr", "https://cams.jbnucpu.co.kr", "http://jbnucpu.co.kr"));
